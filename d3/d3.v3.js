d3 = function() {
  ...
  d3.scale.log = function() {
    return d3_scale_log(d3.scaleLinear(), d3_scale_logp);
  };
  ...
  d3.scale.pow = function() {
    return d3_scale_pow(d3.scaleLinear(), 1);
  };
  ...
  d3.svg.axis = function() {
    var scale = d3.scaleLinear(), orient = d3_svg_axisDefaultOrient, tickMajorSize = 6, tickMinorSize = 6, tickEndSize = 6, tickPadding = 3, tickArguments_ = [ 10 ], tickValues = null, tickFormat_, tickSubdivide = 0;
    function axis(g) {
      g.each(function() {
  ...
  var d3_time_scaleLinear = d3.scaleLinear(), d3_time_scaleLocalFormat = d3_time_scaleFormat(d3_time_scaleLocalFormats);
  d3_time_scaleLocalMethods.year = function(extent, m) {
    return d3_time_scaleLinear.domain(extent.map(d3_time_scaleGetYear)).ticks(m).map(d3_time_scaleSetYear);
  };
  d3.time.scale = function() {
    return d3_time_scale(d3.scaleLinear(), d3_time_scaleLocalMethods, d3_time_scaleLocalFormat);
  };
  ...
  d3.time.scale.utc = function() {
    return d3_time_scale(d3.scaleLinear(), d3_time_scaleUTCMethods, d3_time_scaleUTCFormat);
  };
  return d3;
}();